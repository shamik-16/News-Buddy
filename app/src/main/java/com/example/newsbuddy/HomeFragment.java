...
public class HomeFragment extends Fragment {
    ...
    private void fetchNews() {
        ...
        ApiUtilities.getApiInterface().getNews(country,100,api).enqueue(new Callback<NewsMenuDetails>() {
            @Override
            public void onResponse(@NonNull Call<NewsMenuDetails> call, @NonNull Response<NewsMenuDetails> response) {
            ...
            public void onFailure(Call<NewsMenuDetails> call, Throwable t) {
                pgBar.setVisibility(View.GONE);
                Toast.makeText(getContext(),"Can't Fetch News",Toast.LENGTH_SHORT).show();
            }
        });
